...
---- revive
local revive_seq = {
  {"mini@cpr@char_a@cpr_def","cpr_intro",8.0, 1.0, -1, 2, 0, 0, 0, 0},
  {"mini@cpr@char_a@cpr_str","cpr_pumpchest",8.0, 1.0, -1, 9, 0, 0, 0, 0},
  {"mini@cpr@char_a@cpr_def","cpr_success",8.0, 1.0, -1, 2, 0, 0, 0, 0}
}
...
RegisterCommand('an3ash', function(player, args, rawCommand)
  local user_id = vRP.getUserId(player)
  if user_id ~= nil then
    vRPclient.getNearestPlayer(player,{10},function(nplayer)
      local nuser_id = vRP.getUserId(nplayer)
