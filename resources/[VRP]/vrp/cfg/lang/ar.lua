...
local lang = {
  ...
  cityhall = {
    ...
    menu = {
      title = "الهوية",
      info = "<em>الاسم الاول: </em>{2}<br /><em>الاسم الاخير: </em>{1}<br /><em>العمر: </em>{3}<br /><em>الاستمارة n°: </em>{4}<br /><em>الجوال: </em>{5}<br /><em>العنوان: </em>{6}<br /><em>الوظيفة: </em>{8}, {7}"
    }
  },
  police = {
    title = "الشرطة",
    ...
    identity = {
      info = "<em>الاسم: </em>{1}<br /><em>اسم الاول: </em>{2}<br /><em>العمر: </em>{3}<br /><em>الاستمارة: </em>{4}<br /><em>الجوال: </em>{5}<br /><em>الشركة: </em>{6}<br /><em>رأس مال الشركة: </em>{7} $<br /><em>العنوان: </em>{8}<br /><em>الوظيفة : </em>{10}, {9}"
    }
  },
  emergency = {
    menu = {
