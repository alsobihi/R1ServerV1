...
local lang = {
  common = {
    welcome = "Welcome. Press F9 to use the menu.~n~last login: {1}",
  ...
  police = {
    ...
    menu = {
      ...
      putinveh = {
        title = "ادخال اللاعب الى السيارة",
        description = "اظغط لادخال اللاعب الى السيارة"
      },
      getoutveh = {
        title = "اخراج اللاعب من السيارة",
        description = "اظغط لأخراج اللاعب من السيارة"
      },
      askid = {
        title = "طلب الهوية",
  ...
  phone = {
    ...
    service = {
      ...
      description = "للتواصل مع الطوارئ كريم & ميكانيكي",
    ...
    announce = {
      title = "اعلان",
      description = "اظغط لارسال اعلان عام ؟",
      item_desc = "{1} $<br /><br/>{2}",
