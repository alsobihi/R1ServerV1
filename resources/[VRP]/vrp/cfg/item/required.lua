...
items["medkit"] = {"اسعافات أوليه","Used to reanimate unconscious people.",nil,0.5}
items["dirty_money"] = {"اموال قذره","Illegally earned money.",nil,0}
items["parcels"] = {"طرود","Parcels to deliver",nil,0.10}
items["repairkit"] = {"عدة إصلاح","Used to repair vehicles.",nil,0.5}
